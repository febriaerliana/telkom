...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar js-scroll-trigger" href="/index#page-top"><img src="{{ asset('img/logos/telkom-logo.png') }}" height="50px" alt="" /></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
                ...
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="/index#contact">Hubungi</a></li>
            </ul>
        </div>
    </div>
</nav>